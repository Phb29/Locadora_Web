...
namespace WebLocadora.Areas.Admin.Controllers
{
    ...
    public class PedidosController : Controller
    {
        ...
        public IActionResult PedidoFilmes(int? id)
        {
            var pedido = _context.Pedidos.Include(f => f.PedidoItens)
                .ThenInclude(f => f.Filme).FirstOrDefault(p => p.PedidoId == id);
            ...
            PedidoFilmeViewModel pedidoFilme = new PedidoFilmeViewModel(){
            Pedido=pedido,
                    PedidoDetalhes=pedido.PedidoItens
                    
            };
            return View(pedidoFilme);   
